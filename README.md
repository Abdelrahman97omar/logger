...
1. If you are installing the logger for the first time, run: **sudo pip install --upgrade pip** 
2. sudo pip install --upgrade --force-reinstall --no-cache-dir git+https://github.com/Abdelrahman97omar/logger.git
3. logger-install
